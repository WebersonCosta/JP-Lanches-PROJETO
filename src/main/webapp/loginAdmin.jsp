...
<body>
	<main>
		<header>
			<nav>
				<div class="logo">
					<a href="index.html"><img src="assets/img/logo/logo-ppp.png"
						alt="#"></a>
				</div>
				<div class="menu-btn">
				...
				<ul>
					<li><a href="adminTable" class="active">CADASTRAR</a></li>
				</ul>
			</nav>
		</header>
		<div class="linha">
			<section class="home-imagem-logo login-logo">
				<picture class="container-logo-login"> <img
					src="assets/img/logo/logo-g.png" alt="logo marca da pizzaria"
					class="dinamic-login"> </picture>
			</section>
			<section class="login-box">
				...
				<div class="btn-padrao-c">
					<a href="index.html">CONFIRMAR</a>
				</div>
			</section>
		</div>
	</main>
